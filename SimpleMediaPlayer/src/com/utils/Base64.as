...
package com.utils {
    ...
    public final class Base64 {
        ...
        public static function encode(_arg1:String):String{
            ...
            return (encode2string(_local2));
        }
        public static function encode2string(_arg1:ByteArray):String{
            var _local3:Array;
            var _local5:uint;
            var _local6:uint;
            var _local7:uint;
        ...
        public static function decode(_arg1:String):String{
            var _local2:ByteArray = decode2bytes(_arg1);
            return (_local2.readUTFBytes(_local2.length));
        }
        public static function decode2bytes(_arg1:String):ByteArray{
            var _local6:uint;
            var _local7:uint;
            var _local2:ByteArray = new ByteArray();
